...
This creates a self-contained binary—no separate frontend server needed. Access at http://localhost:8181.
...
| Frontend can't reach API | Ensure backend is running on port 8181 |
